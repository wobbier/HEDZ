...
bool FUN_0046dec0(HINSTANCE param_1);
...
void FUN_004ad0f0(LPSECURITY_ATTRIBUTES param_1,SIZE_T param_2,LPTHREAD_START_ROUTINE param_3,LPVOID param_4,DWORD param_5,LPDWORD param_6);
...
void FUN_004b1a50(int param_1);
void FUN_004b1a70(uint param_1);
void FUN_004b1ab0(int param_1,int param_2);
void FUN_004b1ae0(uint param_1);
void FUN_004b1b20(int param_1,int param_2);
